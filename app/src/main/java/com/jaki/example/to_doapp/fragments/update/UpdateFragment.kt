package com.jaki.example.to_doapp.fragments.update
...
import com.jaki.example.to_doapp.databinding.FragmentUpdateBinding
...
class UpdateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding?.spinnerPrioritasCurrent?.onItemSelectedListener = mSharedViewModel.listener
